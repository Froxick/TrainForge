...
2. Форма создания упражнений (выполненно)
3. Селектор тегов (выполненно)
4. Селектор рейтинга (выполненно)
5. Кнопка удаления упражнений с флагом createdByUser (выполненно)
6. Форма редактирования упражнений с флагом createdByUser (выполненно)
7. Фильтрация упражнений по тегам 
8. Сортировка упражнений по рейтингу (выполненно)
9. Фильтрация по флагу createdByUser (выполненно)
