...
8. Написать хук useExerciseCatalogForm 
...
#### Задачи: 
1. Форма создания упражнений 
2. Кнопка удаления упражнений с флагом createdByUser
3. Форма редактирования упражнений с флагом createdByUser
4. Фильтрация упражнений по тегам
5. Фильтрация упражнений по рейтингу 
6. Фильтрация по флагу createdByUser
